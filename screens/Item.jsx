import { View, Text, ActivityIndicator, Image, SafeAreaView, TouchableOpacity } from 'react-native'
  ...
  return (
    <View className="flex-1 items-center justify-center bg-[#04020d] relative">
      ...
      <SafeAreaView className="absolute z-10 inset-0 flex items-center justify-start">
        <TouchableOpacity onPress={() => navigation.navigate("HomeScreen")} className="w-full flex px-4">
        <Ionicons name="arrow-back" size={32} color="white" />
        </TouchableOpacity>
        <View className="w-full h-full relative">
            <View className="absolute bottom-12 inset-x-0 px-4">
                <BlurView className="p-4 flex-row items-center justify-between"
                intensity={60} tint="dark">
                    ...
                    <TouchableOpacity onPress={handleDownload}>
                      <Ionicons name="md-cloud-download-sharp" size={24}
                      color="white"/>
                    </TouchableOpacity>
